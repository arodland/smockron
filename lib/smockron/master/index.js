...
function Master(config) {
  this.config = config;
  this.socket = new Socket(this.config.socket);
  ...
  this.socket.on('accounting', this._onAccounting.bind(this));
  this.socket.on('hello', this._onHello.bind(this));
};
...
Master.prototype._onHello = function(msg, rinfo) {
